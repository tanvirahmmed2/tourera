  ...
  return (
    <div className="max-w-6xl mx-auto pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        {/* Core Stats */}
        <div className="bg-white/5 border border-primary/20 rounded-2xl p-6 transition-all hover:bg-primary/10 hover:-translate-y-0.5">
        ...
        <div className="bg-white/5 border border-primary/20 rounded-2xl p-6 transition-all flex flex-col hover:bg-primary/10 hover:-translate-y-0.5">
          ...
          <div className="space-y-4 flex-1">
            <div className="flex flex-col gap-1.5">
              ...
              <select 
                ...
                className="w-full bg-transparent border border-border rounded-lg px-3 py-2 text-sm font-bold text-text focus:outline-none focus:border-primary/50"
              >
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input 
                ...
                className="w-full bg-transparent border border-border rounded-lg px-3 py-2 text-sm font-medium text-text focus:outline-none focus:border-primary/50"
              />
            </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mb-8">
        {/* User Roster */}
        <div className="bg-white/5 border border-border rounded-2xl overflow-hidden flex flex-col transition-all hover:-translate-y-0.5">
          <div className="flex items-center justify-between p-5 border-b border-border bg-transparent">
              ...
              <tbody className="divide-y divide-border">
                {tenant.invoices?.length === 0 ? (
                  ...
                  tenant.invoices?.map(inv => (
                    <tr key={inv.invoice_id} className="hover:bg-white/5 transition-colors">
      ...
      {/* Change Status */}
      <div className="bg-transparent border border-red-900/50 rounded-2xl overflow-hidden">
        <div className="flex items-center justify-between p-5 px-6 border-b border-red-900/50 bg-red-900/20">
        ...
        <div className="p-6 flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-transparent">
          <select
            className="bg-transparent border border-border rounded-xl px-4 py-2.5 text-sm font-bold text-text focus:outline-none focus:border-primary/50 w-[200px]"
            value={editStatus}
